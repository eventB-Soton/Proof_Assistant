...
entryRuleXProofAssistant returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getXProofAssistantRule()); }
	iv_ruleXProofAssistant=ruleXProofAssistant
	{ $current=$iv_ruleXProofAssistant.current; }
	EOF;

// Rule XProofAssistant
ruleXProofAssistant returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleXHint returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getXHintRule()); }
	iv_ruleXHint=ruleXHint
	{ $current=$iv_ruleXHint.current; }
	EOF;

// Rule XHint
ruleXHint returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		{
			$current = $this_XSelectionHint_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_XCasesHint_1.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleXSelectionHint returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getXSelectionHintRule()); }
	iv_ruleXSelectionHint=ruleXSelectionHint
	{ $current=$iv_ruleXSelectionHint.current; }
	EOF;

// Rule XSelectionHint
ruleXSelectionHint returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleXCasesHint returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getXCasesHintRule()); }
	iv_ruleXCasesHint=ruleXCasesHint
	{ $current=$iv_ruleXCasesHint.current; }
	EOF;

// Rule XCasesHint
ruleXCasesHint returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleXCase returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getXCaseRule()); }
	iv_ruleXCase=ruleXCase
	{ $current=$iv_ruleXCase.current; }
	EOF;

// Rule XCase
ruleXCase returns [EObject current=null]
@init {
	enterRule();
}
@after {
