...
public class ProofAssistantGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class HintElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cSelectionHintParserRuleCall_0 = (RuleCall)cAlternatives.eContents().get(0);
		private final RuleCall cCasesHintParserRuleCall_1 = (RuleCall)cAlternatives.eContents().get(1);
		
		//Hint:
		//	SelectionHint | CasesHint;
		@Override public ParserRule getRule() { return rule; }
		...
		//SelectionHint
		public RuleCall getSelectionHintParserRuleCall_0() { return cSelectionHintParserRuleCall_0; }
		
		//CasesHint
		public RuleCall getCasesHintParserRuleCall_1() { return cCasesHintParserRuleCall_1; }
	}
	...
	public class CasesHintElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "ac.soton.xeventb.ProofAssistant.CasesHint");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cForKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Assignment cElementAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final CrossReference cElementEventBElementCrossReference_1_0 = (CrossReference)cElementAssignment_1.eContents().get(0);
	...
	public class CaseElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "ac.soton.xeventb.ProofAssistant.Case");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class XFormulaElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "ac.soton.xeventb.ProofAssistant.XFormula");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class EVENTB_IDENTIFIER_KEYWORDElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "ac.soton.xeventb.ProofAssistant.EVENTB_IDENTIFIER_KEYWORD");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class EVENTB_PREDICATE_SYMBOLSElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "ac.soton.xeventb.ProofAssistant.EVENTB_PREDICATE_SYMBOLS");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class EVENTB_EXPRESSION_SYMBOLSElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "ac.soton.xeventb.ProofAssistant.EVENTB_EXPRESSION_SYMBOLS");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	private final CasesHintElements pCasesHint;
	...
	public ProofAssistantGrammarAccess(GrammarProvider grammarProvider,
		...
		this.pCasesHint = new CasesHintElements();
		this.pCase = new CaseElements();
		this.tXLABEL = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "ac.soton.xeventb.ProofAssistant.XLABEL");
		...
		this.tID = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "ac.soton.xeventb.ProofAssistant.ID");
	}
	...
	public ParserRule getCasesHintRule() {
		return getCasesHintAccess().getRule();
	}
